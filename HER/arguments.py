...
def get_args():
    ...
    parser.add_argument('--env-name', type=str, default='FetchReach-v3', help='the environment name')
    ...
    # parser.add_argument('--replay-strategy', type=str, default='skladksdkl', help='the HER strategy')
    ...
    # parser.add_argument('--entropy-regularization', type=float, default=0.2, help='entropy-regularization factor (alpha) for sac')
    ...
    parser.add_argument('--n-test-rollouts', type=int, default=40, help='the number of tests')
    ...
    parser.add_argument('--ratio-clip', type=float, default=.3, help='clip of ratio used in correcting HER values')
