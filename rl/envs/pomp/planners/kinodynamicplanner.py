...
class Node:
    ...
    def setParent(self,p,uparent=None,eparent=None):
        ...
        # self.uparent = p.x
        # self.eparent = self.controlSpace.interpolator(nnear.x,u)
    ...
    def set_cost(self, ctc):
        self.c = ctc

    def set_cost_bound(self, cost_bound):
        updated_locs = []
        if self.cost_bound == None or cost_bound < self.cost_bound:
            self.cost_bound = cost_bound
            updated_locs.append(self.x)
            if self.parent is not None:
                updated_locs += self.parent.set_cost_bound(cost_bound)
...
# class BidirectionalPlanner(TreePlanner):
#     def __init__(self, constructor):
#         self.constructor = constructor

#     def initialize(self, *args, **kwargs):
#         self.forward_tree = self.constructor(*args, **kwargs)
#         self.backward_tree = self.constructor(*args, **kwargs)

#     def setBoundaryConditions(self,*args):
#     # def __getattr__(self, attr): 
#     #     if attr not in self.__dict__: 
#     #         return getattr(self.obj, attr) 
#     #     return self.forward_tree.__getattr__(attr)

#     def destroy(self):
#         pass

#     def setRoot(self,x):
#         self.forward_tree.setRoot(x)
#         pass
